...
function start() {
  ...
  if(otoekle == "var"){
    document.querySelector(".chckyz").innerHTML="First letters are adding automatically.";
    setTimeout(() => {
      document.querySelector("#chckb").style.display="none";
    }, 1000);
  } else{
    document.querySelector(".chckyz").innerHTML="First letters are not adding automatically.";
    setTimeout(() => {
      document.querySelector("#chckb").style.display="none";
    }, 1000);
  }
  ...
  try {
    ...
    if (sozluk.includes(word)) {
      ...
      setTimeout(() => {
        ...
        yenilgi.querySelector(".ynl h2").innerHTML="You've found "+a+" word(s) in total.";
...
function oncedenyaz(){
  ...
  document.getElementById("hatasebep").innerHTML="You've already written this word!";
  document.querySelector("#hata").style="animation: hatavar 1.25s ease-in-out alternate; animation-iteration-count: 2";
  setTimeout(() => {
    document.querySelector("#hata").style="";
  }, 2500);
